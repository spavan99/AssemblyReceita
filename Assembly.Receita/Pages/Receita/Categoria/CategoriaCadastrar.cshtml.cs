...
namespace Assembly.Receita.Pages.Receita.Categoria
{
    ...
    public class CategoriaCadastrarModel : PageModel
    {
        //injeçao de depencia
        private readonly ICategoriaRepository _Repository;
        private readonly ICategoriaService _Service;

        public CategoriaCadastrarModel(ICategoriaRepository Repository, ICategoriaService Service)
        {
        ...
        [BindProperty]
        public DtosCategoriaFull novoCadastro { get; set; } = new DtosCategoriaFull();
        ...
        public void OnGet([FromQuery] int? IdOrigem, [FromQuery] string? acaoOrigem)
        {
            ...
            if (IdOrigem.HasValue && !string.IsNullOrEmpty(acaoOrigem))
            {
                ...
                if (achou.Count == 1)
                {
                    ...
                    novoCadastro.NomeCategoria = achou[0].NomeCategoria;
                }
            ...
            DtosCategoriaFull obj = new DtosCategoriaFull();

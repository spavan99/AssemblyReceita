...
namespace Assembly.Receita.Pages.Receita.Categoria
{
    [Authorize(policy: "Admin")] // Authenticated
    public class CatgoriaCRUDModel : PageModel
    {
        //injeçao de depencia
        private readonly ICategoriaRepository _Repository;
        private readonly ICategoriaService _Service;

        public CatgoriaCRUDModel(ICategoriaRepository Repository, ICategoriaService Service)
        {
        ...
        // ******************************** grupo dados alterar
        // Dados filtrado
        public List<DtosCategoriaFull> dadosFiltro { get; set; } = new List<DtosCategoriaFull>();
        //public List<dynamic> dadosFiltro { get; set; } = new List<dynamic>();

        //rota lista - atual
        public string rotaLista { get; set; } = "/Receita/Categoria/CategoriaCRUD";

        //rota lista - cadastro/update/delete/l
        public string rotaCRUD { get; set; } = "/Receita/Categoria/CategoriaCadastrar";

        private string titulo { get; set; } = "Cadastro de Categoria Receita";
        ...
        public async Task OnGet()
        {
            ...
            pesq2.descPesquisa = "Nome da Categoria";
            pesq2.nCampo = "NomeCategoria";
            ...
            listCamposTAB.Add("NomeCategoria");
            descricaoCamposTAB.Add("Descriçao da Categoria");

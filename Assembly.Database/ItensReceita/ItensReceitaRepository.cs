...
{
    public class ItensReceitaRepository : IItensReceitaRepository
    {
        public string _tabela = MapDataBase.GetItensReceitaTable();
        ...
        {            // campo excluir para insert geralmente Id (gerado automatico)
            ...
            //inserir registro
            var ret = SQLCRUDInsert.SQLInset<ItensReceita>(_sql, campos, obj, campoexcluir);
        ...
        public List<dynamic> GetAll(List<SQLDTOSPesquisa> nChave, string _sqlComplexa = null)
        {
            ...
            ItensReceita nbranco = new ItensReceita();
        ...
        public bool Update(ItensReceita obj)
        {
            ...
            //alterar o regritro
            var ret = SQLCRUDUpdate.SQLUpdate<ItensReceita, int>(_sql, campos, obj, campoexcluir, "Id", obj.Id);

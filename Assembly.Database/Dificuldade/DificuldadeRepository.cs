...
namespace Assembly.Database
{
    ...
    {
        public string _tabela = MapDataBase.GetDificuldadeTable();
        public Dificuldade Add(Dificuldade obj)
        {
            ...
            //inserir registro
            var ret = SQLCRUDInsert.SQLInset<Dificuldade>(_sql, campos, obj, campoexcluir);
        ...
        public List<dynamic> GetAll(List<SQLDTOSPesquisa> nChave, string _sqlComplexa = null)
        {
            ...
            Dificuldade nbranco = new Dificuldade();
        ...
        public bool Update(Dificuldade obj)
        {
            ...
            //alterar o regritro
            var ret = SQLCRUDUpdate.SQLUpdate<Dificuldade, int>(_sql, campos, obj, campoexcluir, "Id", obj.Id);
